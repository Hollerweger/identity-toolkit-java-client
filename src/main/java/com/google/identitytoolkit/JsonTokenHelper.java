...
public class JsonTokenHelper {
  ...
  public static final String ID_TOKEN_ISSUED = "iat";
  public static final String ID_TOKEN_EXPIRES = "exp";
  ...
  public JsonTokenHelper(String audience, RpcHelper rpcHelper, String serverApiKey) {
    ...
    verifierProviders.setVerifierProvider(SignatureAlgorithm.RS256, new GitkitVerifierManager(
        rpcHelper, serverApiKey));
    this.parser = new JsonTokenParser(verifierProviders, new AudienceChecker(audience));
  }
  ...
  public static class AudienceChecker implements Checker {
    ...
    public void check(JsonObject payload) throws SignatureException {
      ...
      if (!this.expectedAudience.equals(audience)) {
        throw new SignatureException(String.format("Invalid audience: %s. Should be: %s", audience,
